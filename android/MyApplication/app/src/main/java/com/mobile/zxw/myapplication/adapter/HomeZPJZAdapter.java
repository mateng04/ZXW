...
public class HomeZPJZAdapter extends BaseAdapter  {
    private List<HomeZPJZBean> list = null;
    private Context mContext;

    public HomeZPJZAdapter(Context mContext, List<HomeZPJZBean> list) {
     ...
     * @param list
     */
    public void updateListView(List<HomeZPJZBean> list) {
        this.list = list;
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        final HomeZPJZBean homeZPJZBean = list.get(position);
        if (view == null) {
        ...
        if ("置顶".equals(homeZPJZBean.getHrJianZhiIDZD())) {
        ...
        viewHolder.tv_home_zp_title.setText(this.list.get(position).getHrJianZhiTile());
        String timeTemp = (this.list.get(position).getHrJianZhiTime());
