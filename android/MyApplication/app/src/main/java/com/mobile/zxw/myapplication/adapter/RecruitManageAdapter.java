...
public class RecruitManageAdapter extends BaseAdapter  {
    private List<RecruitManageBean> list = null;
    private Context mContext;
    private Handler handler;
    String dataflag;

    public RecruitManageAdapter(Context mContext, List<RecruitManageBean> list,Handler handler,String dataflag) {
    ...
    public void setFlay(String flag){
        dataflag = flag;
    }
...
//                Toast.makeText(mContext,"删除"+recruitManageBean.getHrID(),Toast.LENGTH_SHORT).show();
        ...
        viewHolder.tv_item_rm_sx.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Toast.makeText(mContext,"删除"+recruitManageBean.getHrID(),Toast.LENGTH_SHORT).show();
