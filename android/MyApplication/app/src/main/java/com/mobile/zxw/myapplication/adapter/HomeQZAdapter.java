...
public class HomeQZAdapter extends BaseAdapter  {
    private List<HomeQZBean> list = null;
    private Context mContext;

    public HomeQZAdapter(Context mContext, List<HomeQZBean> list) {
     ...
     * @param list
     */
    public void updateListView(List<HomeQZBean> list) {
        this.list = list;
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        final HomeQZBean hmeQZBean = list.get(position);
        if (view == null) {
        ...
        if ("置顶".equals(hmeQZBean.getJobQuanZhiZD())) {
        ...
        viewHolder.tv_home_zp_title.setText(this.list.get(position).getJobQuanZhiTile());
        String timeTemp = (this.list.get(position).getJobQuanZhiTime());
