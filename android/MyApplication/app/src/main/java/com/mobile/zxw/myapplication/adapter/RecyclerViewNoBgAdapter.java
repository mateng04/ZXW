...
public class RecyclerViewNoBgAdapter extends RecyclerView.Adapter<RecyclerViewNoBgAdapter.ViewHolder> implements View.OnClickListener {
    private static final String TAG = RecyclerViewNoBgAdapter.class.getSimpleName();
    ...
    public RecyclerViewNoBgAdapter(Context context, List<String> data) {
        this.data = data;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            home_sd_item_pic= (ImageView) itemView.findViewById(R.id.recycle_sd_item_pic);
        }
    }
