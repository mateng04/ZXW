...
public class AdvertisingContentAdapter extends RecyclerView.Adapter<AdvertisingContentAdapter.ViewHolder> implements View.OnClickListener {
    private static final String TAG = AdvertisingContentAdapter.class.getSimpleName();
    ...
    public AdvertisingContentAdapter(Context context, List<String> data) {
        this.data = data;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            home_sd_item_pic= (ImageView) itemView.findViewById(R.id.advertising_sd_item_pic);
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = inflater.inflate(R.layout.item_recy_nobg, parent, false);
