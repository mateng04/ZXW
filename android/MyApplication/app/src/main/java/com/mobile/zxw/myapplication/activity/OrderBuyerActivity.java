...
public class OrderBuyerActivity extends AppCompatActivity implements XListView.IXListViewListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferencesHelper = new SharedPreferencesHelper(
                OrderBuyerActivity.this, "config");
    ...
    public void initView(){
        ...
        adapter_message = new OrderManageAdapter(OrderBuyerActivity.this,list_messages);
        mListView.setAdapter(adapter_message);

        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(OrderBuyerActivity.this,OrderDetailsActivity.class);
                intent.putExtra("dingdanhao",list_messages.get(position-1).getDdh());
                intent.putExtra("laiyuan","buy");
