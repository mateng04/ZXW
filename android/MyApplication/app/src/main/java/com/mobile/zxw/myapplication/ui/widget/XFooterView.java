...
/**
 * The footer view for {@link com.mobile.zxw.myapplication.ui.widget.XListView} and
 * {@link com.mobile.zxw.myapplication.ui.widget.XScrollView}
 *
 * @author markmjw
 * @date 2013-10-08
 */
...
//                    mHintImage.startAnimation(mRotateUpAnim);
            ...
            case STATE_LOADING:
                break;
            case STATE_COMPLETE:
                mHintView.setText(R.string.footer_hint_load_complete);
                break;
        }
