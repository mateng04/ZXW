...
//                    Toast.makeText(mContext,"",Toast.LENGTH_LONG).show();
    ...
    public void initView(){
        ...
        et_modify_ws_mal_wxzql_spxq.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                switch (v.getId()) {
                    case R.id.et_modify_ws_mal_wxzql_spxq:
                        // 解决scrollView中嵌套EditText导致不能上下滑动的问题
                        if (canVerticalScroll(et_modify_ws_mal_wxzql_spxq))
