...
public class HomeSDAdapter extends RecyclerView.Adapter<HomeSDAdapter.ViewHolder> implements View.OnClickListener {
    private static final String TAG = HomeSDAdapter.class.getSimpleName();
    ...
    public HomeSDAdapter(Context context, List<HomeSCBean> data, String tag) {
        this.data = data;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        new GlideImageLoader().displayImage(context,data.get(position).getShopPicUrl(),holder.home_sd_item_pic);
...
//        holder.itemView.setLayoutParams(layoutParams);
    ...
    public interface OnItemClickListener{
        void onItemClick(int position, HomeSCBean model);
    }
