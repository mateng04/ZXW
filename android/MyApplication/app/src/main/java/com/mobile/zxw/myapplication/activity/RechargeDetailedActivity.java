...
public class RechargeDetailedActivity extends AppCompatActivity implements XListView.IXListViewListener, View.OnClickListener{
    ...
    private Button recharge_detailed_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferencesHelper = new SharedPreferencesHelper(
                RechargeDetailedActivity.this, "config");
    ...
    public void initView(){
        ...
        mListView = (XListView)findViewById(R.id.lv_recharge_detailed);
        ...
        adapter_message = new RechargeDetailedAdapter(RechargeDetailedActivity.this,list_messages);
        mListView.setAdapter(adapter_message);

        recharge_detailed_back = (Button)findViewById(R.id.recharge_detailed_back);
        recharge_detailed_back.setOnClickListener(this);
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.recharge_detailed_back :
                finish();
                break;
