...
import com.mobile.zxw.myapplication.activity.ReleaseMallActivity;
    ...
    public class SelectedPicViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(int position) {
            ...
            if (isAdded && position == getItemCount() - 1) {
                ...
                if(type == 3){
                    clickPosition = ReleaseMallActivity.IMAGE_ITEM_ADD_3;
                }else{
                    clickPosition = ReleaseMallActivity.IMAGE_ITEM_ADD;
                }
...
//                clickPosition = position;
                if(type == 3){
                    clickPosition = ReleaseMallActivity.IMAGE_ITEM_ADD_33;
                }else{
                    clickPosition = position;
                }
            }
